...
public class UserApiController {
  ...
  public void generate(
    ...
    userService.generate(uuid, servletResponse, tenantId);
  }

  @PostMapping(value = UserServiceConstants.VALIDATE_MFA)
  public ResponseEntity<ValidateCodeResponse> validateKey(
      @RequestBody ValidateCodeRequest validateCodeRequest,
      @RequestHeader("tenantId") String tenantId) {
    var response = userService.validateKey(validateCodeRequest, tenantId);
    return new ResponseEntity<>(response, HttpStatus.OK);
  }
