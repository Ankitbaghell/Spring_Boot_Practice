...
public final class UserServiceConstants {
  ...
  public static final String VALIDATE_MFA = "/validate/key";
    ...
    public static final String MFA_BASE_URL = "/mfa";
    public static final String GET_SCRATCHES = "/scratches/{uuid}";

    public static final String VALIDATE_SCRATCH_CODE ="/validate-scratch" ;
}
